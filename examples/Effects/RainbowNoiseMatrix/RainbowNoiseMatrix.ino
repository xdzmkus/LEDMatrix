...
void changeEffect()
{
	...
	effect = new NoiseMatrixLedEffect(&matrix, leds, NUM_LEDS, speed, RainbowColors_p, zoom);
...
void setup()
{
	...
	effect = new NoiseMatrixLedEffect(&matrix, leds, NUM_LEDS, 15, RainbowColors_p);
