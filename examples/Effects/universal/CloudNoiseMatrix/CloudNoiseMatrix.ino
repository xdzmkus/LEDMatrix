...
void changeEffect()
{
	...
	effect = new NoiseMatrixLedEffect<ZigZagFromTopLeftToBottomAndRight, leds, MATRIX_W, MATRIX_H>(speed, CloudColors_p, zoom);
...
void setup()
{
	...
	Serial.println(F("Cloud Noise effect"));

	setupLED();

	effect = new NoiseMatrixLedEffect<ZigZagFromTopLeftToBottomAndRight, leds, MATRIX_W, MATRIX_H>(15, CloudColors_p);
