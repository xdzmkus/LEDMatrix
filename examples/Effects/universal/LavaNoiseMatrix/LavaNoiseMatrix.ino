...
void changeEffect()
{
	...
	effect = new NoiseMatrixLedEffect<ZigZagFromTopLeftToBottomAndRight, leds, MATRIX_W, MATRIX_H>(speed, LavaColors_p, zoom);
...
void setup()
{
	...
	Serial.println(F("Lava Noise effect"));

	setupLED();

	effect = new NoiseMatrixLedEffect<ZigZagFromTopLeftToBottomAndRight, leds, MATRIX_W, MATRIX_H>(15, LavaColors_p);
