...
void changeEffect()
{
	...
	effect = new NoiseMatrixLedEffect<ZigZagFromTopLeftToBottomAndRight, leds, MATRIX_W, MATRIX_H>(speed, PartyColors_p, zoom);
...
void setup()
{
	...
	Serial.println(F("Party Noise effect"));

	setupLED();

	effect = new NoiseMatrixLedEffect<ZigZagFromTopLeftToBottomAndRight, leds, MATRIX_W, MATRIX_H>(15, PartyColors_p);
